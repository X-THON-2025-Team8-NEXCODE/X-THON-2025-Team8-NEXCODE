...
domain = "https://x-thon.nexcode.kr:16011"
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', debug=True, port=16011, ssl_context=('./cert_nexcode.kr/nexcode.kr.cer', './cert_nexcode.kr/nexcode.kr.key'))